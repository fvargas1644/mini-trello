...
function ListTitle(props) {
    ...
    const listNameInputRef = useRef(props.listName);
    ...
    const handleListNameInputChange = async (event) => {
        ...
        let data = await listCrud(({ type: 'CHANGE_LIST_NAME', id: props.listId, name: event.target.value})) // Llama a la función proporcionada para manejar el cambio
